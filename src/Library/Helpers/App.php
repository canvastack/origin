...
if (!function_exists('canvastack_set_filesize')) {
	 ...
	 * @return number
	 */
	function canvastack_set_filesize($size, $type = 'M') {
...
if (!function_exists('canvastack_image_validations')) {
	 ...
	 * @return string
	 */
	function canvastack_image_validations($max_size = false) {
		$max = false;
...
if (!function_exists('canvastack_file_validations')) {
	 ...
	 * @return string
	 */
	function canvastack_file_validations($mimes = "txt", $max_size = false) {
		$max = false;
		if (false !== $max_size) $max = "|max:{$max_size}";
...
if (!function_exists('canvastack_make_dir')) {
	 ...
	 * @param bool $force
	 */
	function canvastack_make_dir($filePath, $mode = 0777, $recursive = true, $force = true) {
